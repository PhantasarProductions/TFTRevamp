...
-- File Generated: Sun 21 May 2017; 13:38:47
...
local foe = {}
	...
	foe["Desc"] = "Can only attack\44 but it strikes hard"
	foe["Image"] = "GFX\47Combat\47Fighters\47Foe\47Reg\47BSpook\46png"
	foe["Item Drop \49"] = "EQP_MARRILONA_AR\55"
	foe["Item Drop \50"] = "ITM_BANANA"
	foe["Item Steal \49"] = "ITM_BANANA"
	foe["Item Steal \50"] = "ITM_JUSDORANGE"
	...
	foe["Cash"] = 4
	foe["ER_Darkness"] = 8888
	foe["ER_Earth"] = 100
	foe["ER_Flame"] = -888
	foe["ER_Frost"] = 101
	foe["ER_Light"] = -888
	foe["ER_Lightning"] = 101
	foe["ER_Water"] = 8000
	foe["ER_Wind"] = -800
	foe["Rate Drop \49"] = 20
	foe["Rate Drop \50"] = 1
